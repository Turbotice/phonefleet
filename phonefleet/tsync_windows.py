...
def get_adress(phone):
    ...
    # Extraire le préfixe réseau (par exemple, '192.168.47.')
...
def time_sync(phone,n=1000,timeout=0.1):
    ...
    return(time_sync_ip(ip,n=1000,timeout=0.1))

def get_lag(Dt):

    duration = Dt['duration']
    #in windows, duration is often equal to zero, we arbitrary add some random (small) delay
    #duration 
