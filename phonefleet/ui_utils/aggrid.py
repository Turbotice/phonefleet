...
from nicegui import helpers, optional_features
...
class AgGrid(
    Element,
    component="aggrid.js",
    dependencies=["./ag-grid-community.min.js"],
    ...
    def run_column_method(
        self, name: str, *args, timeout: float = 1
    ) -> AwaitableResponse:  # DEPRECATED
        ...
        """
        helpers.warn_once(
            "The method `run_column_method` is deprecated. "
